...
class User(db.Model):
    ...
    appointments = db.relationship('Slot', backref='user', lazy=True, foreign_keys=['user_id']) # is a 1-to-many relationship by default
    slots = db.relationship('Slot', backref='user', lazy=True, foreign_keys=['provider_id'])
